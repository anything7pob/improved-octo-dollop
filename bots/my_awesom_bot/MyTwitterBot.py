...
class MyTwitterBot(TwitterBot):
    def bot_init(self):
        ...
        ############################
        self.config['api_key'] = '5tYfz9feG1ecSeZSRlxzKGKrR'
        self.config['api_secret'] = 'hurQlRgAb8z6eDbyDiSNniICDuyMNnQB4P1vvtYd4ocMvOwAkH'
        self.config['access_key'] = '745770877-z8vk8IhHJDdOLJc5N3SyhiD2AOgdLqDxZ3CO32I7'
        self.config['access_secret'] = 'D2A97OFwvmrrAwG27EYKQrap4uUGH0ZVzbgSISKFtJhod'
        ...
        self.config['tweet_interval_range'] = (5*60, 10*60) # tweets every 5-10 minutes
        ...
        self.config['autofav_keywords'] = [roofing]
